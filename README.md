...
- The ui was original create in 1080:2240 with 440 dpi. I just test it could work on many different size like: 900x1600, 320 dpi or . However, it still get overflowed with size like: I could fix this if i with screen utils package later on
